...
macro_rules! __ex_message {
    {
        ...
        $(#[$attr])*
        pub struct $name {
            raw: $crate::old_messages::RawMessage
        }

        impl $crate::old_messages::ServiceMessage for $name {
            const SERVICE_ID: u16 = $service_id;
            const MESSAGE_ID: u16 = $message_id;
        }

        impl $crate::old_messages::Message for $name {
            fn from_raw(raw: $crate::old_messages::RawMessage)
            -> ::std::result::Result<$name, $crate::encoding::Error> {
                let min_message_size = $name::__ex_header_size() as usize
                            + $crate::old_messages::HEADER_LENGTH as usize
                ...
                // Check identifiers
                if raw.version() != $crate::old_messages::PROTOCOL_MAJOR_VERSION {
                    return Err($crate::encoding::Error::UnsupportedProtocolVersion {
                        version: $crate::old_messages::PROTOCOL_MAJOR_VERSION
                    });
                }
                if raw.message_type() != <Self as $crate::old_messages::ServiceMessage>::MESSAGE_ID {
                    return Err($crate::encoding::Error::IncorrectMessageType {
                        message_type: <Self as $crate::old_messages::ServiceMessage>::MESSAGE_ID
                    });
                }
                if raw.service_id() != <Self as $crate::old_messages::ServiceMessage>::SERVICE_ID {
                    return Err($crate::encoding::Error::IncorrectServiceId {
                        service_id: <Self as $crate::old_messages::ServiceMessage>::SERVICE_ID
                    });
                }
            ...
            fn raw(&self) -> &$crate::old_messages::RawMessage {
                &self.raw
            }
        }
        ...
        impl<'a> $crate::encoding::SegmentField<'a> for $name {
            ...
            unsafe fn from_buffer(
                ...
                let raw_message: $crate::old_messages::RawMessage =
                                    $crate::encoding::SegmentField::from_buffer(buffer,
                                                                from,
                                                                count);
                $crate::old_messages::Message::from_raw(raw_message).unwrap()
            }
            ...
            fn check_data(
                ...
                let latest_segment_origin = <$crate::old_messages::RawMessage as
                ...
                let _: $name = $crate::old_messages::Message::from_raw(raw_message)?;
        ...
        impl $name {
            ...
            pub fn new($($field_name: $field_type,)*
                ...
                use $crate::old_messages::{RawMessage, MessageWriter};
                let mut writer = MessageWriter::new(
                    $crate::old_messages::PROTOCOL_MAJOR_VERSION,
                    <Self as $crate::old_messages::ServiceMessage>::SERVICE_ID,
                    <Self as $crate::old_messages::ServiceMessage>::MESSAGE_ID,
            ...
            fn check_fields(raw_message: &$crate::old_messages::RawMessage)
            -> $crate::encoding::Result {
                let header_length =
                    $crate::old_messages::HEADER_LENGTH as $crate::encoding::Offset;
        ...
        impl AsRef<$crate::old_messages::RawMessage> for $name {
            fn as_ref(&self) -> &$crate::old_messages::RawMessage {
                $crate::old_messages::Message::raw(self)
            }
        }
        ...
        impl $crate::encoding::serialize::FromHex for $name {
            ...
            fn from_hex<T: AsRef<[u8]>>(hex: T) -> Result<Self, Self::Error> {
                ...
                if vec.len() < $crate::old_messages::HEADER_LENGTH {
                    return Err($crate::encoding::Error::Basic("Hex is too short.".into()));
                }
                let buf = $crate::old_messages::MessageBuffer::from_vec(vec);
                let raw = $crate::old_messages::RawMessage::new(buf);
                $crate::old_messages::Message::from_raw(raw)
            }
        }
        ...
        impl $crate::storage::StorageValue for $name {
            ...
            fn from_bytes(value: ::std::borrow::Cow<[u8]>) -> Self {
                $name {
                    raw: $crate::old_messages::RawMessage::new(
                        $crate::old_messages::MessageBuffer::from_vec(value.into_owned()))
                }
            }
        }
        ...
        impl $crate::encoding::serialize::json::ExonumJsonDeserialize for $name {
                ...
                -> ::std::result::Result<Self, Box<::std::error::Error>>
            {
                ...
                if service_id != <Self as $crate::old_messages::ServiceMessage>::SERVICE_ID {
                    return Err("service_id didn't equal real service_id.".into())
                }

                if message_id != <Self as $crate::old_messages::ServiceMessage>::MESSAGE_ID {
